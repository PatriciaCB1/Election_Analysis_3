...
with open(file_to_save, "w") as txt_file:
    ...
    winning_county_summary = (
        f"-------------------------\n"
        f"Highest Turnout County: {winning_county}\n"
        f"Number of Votes in Highest Turnout County: {winning_county_count:,}\n"
        f"Percentage of Total Votes in Highest Turnout County: {winning_county_percentage:.1f}%\n"
        f"-------------------------\n")
